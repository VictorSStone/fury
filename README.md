# AllMarketing - Angular 2 Material Design Admin Template
## Introduction

AllMarketing is a creative material design admin template built with Angular 2 and the Angular-CLI. It extends the Material Design components built by the Angular 2 team and it offers you everything you need to get started with your next CRM, CMS or dashboard based project.
...
## Table of Contents
   ...
   * [AllMarketing - Angular 2 Material Design Admin Template](#am---angular-2-material-design-admin-template)
